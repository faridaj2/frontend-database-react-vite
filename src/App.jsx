      ...
      <NextUIProvider>
        <Router>
          <Routes>
            ...
            <Route
              path="/dashboard/data-santri/create-siswa"
              element={<PrivateRoute element={CreateSiswa} roles="admin" />}
            />
            <Route
              path="/dashboard/data-santri/detail/:nis"
              element={<DetailSiswa />}
            />
            <Route
              path="/dashboard/data-santri/edit/:nis"
              element={<PrivateRoute element={EditSantri} roles="admin" />}
            />

            {/* Halaman kelola berkas */}
            <Route
              path="/dashboard/data-santri/:nis/kelola-berkas"
              element={<PrivateRoute element={KelolaBerkas} roles="admin" />}
            />
            <Route
              path="/dashboard/data-santri/import-massal"
              element={<PrivateRoute element={ImportMassal} roles="admin" />}
            />

            {/* Halaman Payment */}
            <Route
              path="/dashboard/payment"
              element={<PrivateRoute element={Payment} roles="keuangan" />}
            />
            <Route
              path="/dashboard/payment/detail/:id"
              element={
                <PrivateRoute element={DetailPayment} roles="keuangan" />
              }
            />
            <Route
              path="/dashboard/payment/group-payment/:id"
              element={
                <PrivateRoute element={GroupPaymentDetail} roles="keuangan" />
              }
            />
            <Route
              path="/dashboard/payment/payment-detail/:paymentId/:siswaId"
              element={
            ...
            <Route
              ...
              element={<PrivateRoute element={Laporan} />}
              roles="keuangan"
            />
            {/* Penitipan Uang */}
            <Route
              path="/dashboard/penitipan"
              element={
                <PrivateRoute element={PenitipanUang} roles="penitipan" />
              }
            />
            <Route
              path="/dashboard/penitipan/detail/:id"
              element={
                <PrivateRoute element={DetailPenitipanUang} roles="penitipan" />
              }
            />
            {/* Keamanan */}
            <Route
              path="/dashboard/keamanan"
              element={<PrivateRoute element={Keamanan} roles="keamanan" />}
            />
            <Route
              path="/dashboard/keamanan/detail/:id"
              element={
                <PrivateRoute element={DetailKeamanan} roles="keamanan" />
              }
            />
            <Route
              path="/dashboard/keamanan/riwayat/:id"
              element={
                <PrivateRoute element={RiwayatKeamanan} roles="keamanan" />
              }
            />

            {/* Admin */}
            <Route
              path="/dashboard/zona-admin"
              element={<PrivateRoute element={ZonaAdmin} roles="admin" />}
            />
