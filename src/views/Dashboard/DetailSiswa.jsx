...
function DetailSiswa() {
    ...
    const dataSiswa = [
        ...
        {
            label: "Kelas Diniyah",
            tableName: findMatch(siswa?.diniyah, diniyah),
        },
            ...
            <div className="w-full flex gap-2 flex-col">
                <div className="flex flex-col md:flex-row gap-2 w-full">
                    <div className="w-full md:max-w-sm">
                        <Card className="shadow-xl shadow-violet-700/30">
                            <CardBody>
                                <Image
                                    width={1000}
                        ...
                        <Card className="w-full shadow-xl shadow-violet-700/30">
                            ...
                            <CardFooter>
                                {siswa?.nomor_ayah && (
                                    <Button
                                        color="warning"
                                        className="font-semibold text-white flex items-center mr-2"
                                        onClick={() =>
                                            waButton(siswa?.nomor_ayah)
                                        }
                                    >
                                        <FaWhatsapp /> No Ayah
                                    </Button>
                ...
                <div
                    className={`fixed z-50 right-5 bg-white p-2 shadow rounded-full ${chekAccess()}`}
                >
                    <div className="flex gap-2">
                        <Tooltip content="Edit detail santri">
                            <Button
                                ...
                                onClick={() =>
                                    navigate(
                                        `/dashboard/data-santri/edit/${siswa?.nis}`,
                                    )
                                }
                                isIconOnly
                            >
                    ...
                    <Card className="w-full shadow-xl shadow-violet-700/30">
                        <CardHeader className="flex justify-between">
                            ...
                            <Button
                                ...
                                onClick={() =>
                                    navigate(
                                        `/dashboard/data-santri/${siswa?.nis}/kelola-berkas`,
                                    )
                                }
                            >
                                Kelola Berkas
                        ...
                        <CardBody>
                            <div className="flex gap-2 flex-wrap justify-center md:justify-start">
                                {berkas?.map((berkas) => (
                                    <Card
                                        className="max-w-sm shadow-xl shadow-violet-700/30"
                                        key={berkas.id}
                                    >
                                        <CardHeader>
                        ...
                        <CardBody>
                            <div className="flex gap-2 flex-wrap justify-center md:justify-start">
                                <Accordion>
                                    <AccordionItem
                                        key={1}
                                        aria-label="Pembayaran Berlaku"
                                        title="Pembayaran Berlaku"
                                    >
                                        <div className="flex flex-col md:flex-row gap-2 ">
                                            {pembayaran?.map((item, index) => (
                                                <Link
                                                    to={`/dashboard/payment/payment-detail/${item.id}/${siswa?.id}`}
                                                    color="primary"
                                                    key={index}
                                                    className="py-2 cursor-pointer transition-all bg-blue-500 text-white px-6 py-2 rounded-lg
                                                            border-blue-600
